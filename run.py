...
def testing():
    ...
    request = Request(
        ...
        departure_date_first=datetime.date(2023, 12, 23),
        departure_date_last=datetime.date(2023, 12, 30),
        arrival_date_first=datetime.date(2023, 12, 23),
        arrival_date_last=datetime.date(2023, 12, 30),
        # min_days_stay=2,
        # max_days_stay=5,
        airport_radius=100,
